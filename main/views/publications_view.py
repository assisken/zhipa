...
from main.models import Publication as PublicationModel, Profile, AuthorInfo
...
class PublicationView(ListView):
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        profiles = defaultdict(str, {
            profile.get_short_fio(): reverse('profile-publications', kwargs={'profile': profile.pk})
