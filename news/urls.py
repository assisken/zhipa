...
urlpatterns = [
    ...
    path(
        "<yyyy:date__year>/<mm:date__month>",
        NewsDateListView.as_view(),
        name="news-list",
    ),
    path(
        "<yyyy:date__year>/<mm:date__month>/<dd:date__day>",
        NewsDateListView.as_view(),
        name="news-list",
    ),
    ...
    path(
        "news/<yyyy:date__year>/<mm:date__month>/<dd:date__day>/<slug:url>",
