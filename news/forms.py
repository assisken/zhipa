...
MARKDOWN_HELP = """
    <details>
        <summary><h2>Небольшой экскурс по markdown. Пригодится при написании новости</h2></summary>
        <h2>Помните! Если хотите новую строку — добавьте две в редакторе. Это не баг. Это Markdown</h2>
